...
export const useProjectStore = defineStore('project', () => {
  ...
  const sortedProjects = computed(() => {
    ...
    const fetchProject = async (projectId: number): Promise<ProjectResponse | null> => {
    ...
    const fetchDefaultProject = async (): Promise<ProjectResponse | null> => {
    ...
    const createNewProject = async (projectData: ProjectRequest): Promise<ProjectResponse | null> => {
    ...
    const updateExistingProject = async (projectId: number, projectData: ProjectRequest): Promise<ProjectResponse | null> => {
    ...
    const deleteExistingProject = async (projectId: number): Promise<boolean> => {
