      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleSignup">
        <div class="space-y-4">
          <div>
            ...
            <input id="username" v-model="form.username" type="text" required class="input-field mt-1"
              placeholder="사용자명" />
          </div>
          <div>
...
const { error, fieldErrors, handleError, clearError, getFieldError } = useErrorHandler()
